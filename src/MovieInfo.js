...
export default function MovieInfo() {
  ...
  const m = datam.title || datam.name || datam;
  ...
  useEffect(() => {
    const recom = `https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=680db35a08bf7184a8a2c16cd0d7308e&append_to_response=images`;
    fetch(recom)
      .then((data) => data.json())
      .then((data) => {
        var similar = [];
